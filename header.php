...
<head>
    ...
    <link rel="stylesheet" href="<?php $this->options->themeUrl('css/animation.css'); ?>">
	<link rel="stylesheet" href="<?php $this->options->themeUrl('highlight/styles/default.css'); ?>">
...
<div class="bg" style="background-image:url(<?php $this->options->themeUrl('img/bg.jpg'); ?>)"></div>
<div class="p-bd">
    <div class="g-hd">
		<div class="g-box">
